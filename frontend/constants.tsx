...
export const APPS: AppInfo[] = [
  ...
  },
  {
    ...
    icon: imgGroup19,
    banner: imgGroup19,
    overview: 'A multi-step AI research system that goes beyond retrieval QA into planning, evidence collection, analysis, reporting, and workflow traces. It also powers the Ask experience inside my AI/ML portfolio.',
    stack: 'Frontend: Standalone UI + portfolio Ask integration\nBackend: FastAPI\nData: PostgreSQL\nInfra: Docker Compose\nFocus: agent orchestration, source handling, report generation, eval/readiness workflow',
    outcome: 'Shipped a stronger AI Engineer portfolio project that demonstrates research orchestration, stored outputs, and live integration with the portfolio experience.',
    developer: 'Kyaw Htet',
    featured: true,
